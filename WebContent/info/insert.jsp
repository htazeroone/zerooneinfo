...
<table id="dd" class="table">
	...
	<tr>
		<td>제목</td>
		<td>
		<input type="text" name="title" style="background-color: #D4F4FA; width: 97% ;">
		</td>
	</tr>
	...
	<tr>
		<td>내용</td>
		<td>
		<textarea rows="20" cols="100%" name="content" style="resize: none; background-color: #D4F4FA "></textarea>
		</td>
	</tr>
	...
	<tr>
		<td colspan="2" align="right">
			...
			<input type="button" class="myButton" value="목록으로" onclick="location.href='List?kind=${kind }&page=${page}'">
			<input type="submit" value="입력" class="myButton">
	<%-- 		<a href="List?kind=${kind }&page=${page}">목록으로</a> --%>
		</td>
	</tr>
</table>
</form>
